...
#cat $tokens
parallel --dry-run --gnu --progress --joblog parjobs --xapply -P $parallel ruby -Ibin bin/build_data_extraction.rb -c config.yaml {1} {2} {3} '1>' $dir/{1}@{2}.csv '2>' $dir/{1}@{2}.err ::: `cat $input|cut -f1 -d' '` ::: `cat $input|cut -f2 -d' '` ::: `cat $tokens`
